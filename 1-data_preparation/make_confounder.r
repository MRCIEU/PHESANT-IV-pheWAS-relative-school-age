...
confs = read.table(paste(phenodatadir,'/variables_for_confounder.csv', sep=""), sep=',', header=1)
...
write.table(myconf, paste(phenodatadir,'/confounders-sex_age_asscen.csv',sep=""), sep=',', row.names=FALSE, quote = FALSE)
