...
#SBATCH --job-name=phesant_exposure3_array10
...
#SBATCH --mem=100G
#SBATCH --array=10
echo 'phesant_exposure3_array10'
srun hostname
...
export RES_DIR="${HOME}/2022SchoolAge/results/phesant/exposure3/"
export PROJECT_DATA="/mnt/storage/scratch/bo18534/SchoolAgeMiniProject/"



expFile="${PROJECT_DATA}Derived/exposure3-wob.csv"
