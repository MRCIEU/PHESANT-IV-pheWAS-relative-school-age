...
#SBATCH --job-name=phesant_exposure1_array10
...
#SBATCH --mem=100G
#SBATCH --array=10
echo 'phesant_exposure1_array10'
srun hostname
...
export RES_DIR="${HOME}/2022SchoolAge/results/phesant/exposure1/"
export PROJECT_DATA="/mnt/storage/scratch/bo18534/SchoolAgeMiniProject/"

expFile="${PROJECT_DATA}Derived/exposure1-Sep_Aug.csv"
